...
/**
  * Ref: https://www.udemy.com/course/taming-big-data-with-spark-streaming-hands-on/
  */

/**
  * We will cluster people on basis of age and income into 5 clusters
  *
  * Commands
  * - nc -kl 9999 -i 1 < src/main/resources/data/kmeans/kmeans-train.txt
  * - nc -kl 7777 -i 1 < src/main/resources/data/kmeans/kmeans-tes
  */
object KMeansClustering {
  ...
  def main(args: Array[String]) {
    ...
    // This expects (cluster ID, [income, age]) lines, but in the real world you wouldn't know the "correct" clustering ahead of time.
